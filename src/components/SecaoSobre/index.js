    ...
    return(
        <section id='sobre' className={ styles.sobre }>
            ...
            <main className={ styles.sobre__principal }>
                ...
                <img className={ styles.sobre__icone } src='./icones-sobre/clock.svg' alt='Ícone'/>
                ...
                <img className={ styles.sobre__icone } src='./icones-sobre/compass.svg' alt='Ícone'/>
                ...
                <img className={ styles.sobre__icone } src='./icones-sobre/hands.svg' alt='Ícone'/>
